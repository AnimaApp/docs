...
-   Change the text value using **Overrides** to see the **Padding** applyed in real-time
...
![](https://cdn-images-1.medium.com/max/1600/1*zww5YwaIm7e4rOiyTSMRAA.png)
...
> 
> ![Enable Padding and Stacks for Nested Symbols](https://cdn-images-1.medium.com/max/1600/1*c1lI8vcNcOlUn7IKa4WJVA.png)
