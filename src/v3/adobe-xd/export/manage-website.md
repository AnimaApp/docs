...
2. Create an **A** record in your domain provider settings
3.  Add your custom domain to your Anima **Website Settings**
...
>**❗️Important**:
>
>- To avoid any security conflicts, your domain provider's settings should only point to Anima's records. Please delete any other existing records.
>
>- Domain changes can take between a few minutes to a few hours to take effect.
